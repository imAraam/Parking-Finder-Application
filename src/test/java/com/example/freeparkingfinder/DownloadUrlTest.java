...
public class DownloadUrlTest {
    ...
    public void readUrl() throws IOException {
        ...
        String urlExpected = "html_attributions" + ": [],"  + "next_page_token" + ":" + "CqQCHAEAAC-KYQptGNr7vo3yFOCCXcw17YGkAHfcptZSL_6o_EGNz0bDScVAeCyq4pt1N6uTNir4mmfOx5Y8ihLCCV54NKB_KlKR" +
        ...
        assertTrue((urlExpected.contains("geometry")) && (urlExpected.contains("name"))
                && (urlExpected.contains("place_id")));
    }
}